				   ...
				   <ul class="nav">
					  <li class="parent">
						...
						<ul class="sub-nav" style="">
							...
							<li><a href="2.user.php">Profile</a></li>
						</ul>
					  </li>
				   </ul>
...
<!--Menu Division Starts-->		
		<div id="tab-container">
			...
			<ul class="tab-menu"> 
                                                        <a href='2.home.php'><li id="tl-dash" class="">Dashboard</li></a>
                                                        <a href='2.compare.php'><li id="com-dash" class="">Operations</li></a>
			</ul>  
			
			<div class="clear"></div> 
			
			<div id="tl-dash-tab" class="tab-content">
			
				<ul class="drop_menu">
					<li id="2.home"><a id="2.home-a" href='2.home.php'>Home</a></li>
                               </ul>
				
			</div>
                        
                        <div id="com-dash-tab" class="tab-content">
