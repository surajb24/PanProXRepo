...
--
-- Dumping data for table `cust_compare_appl_info`
--

INSERT INTO `cust_compare_appl_info` (`SR_NO,N,1`, `FORM_ID,C,18`, `PCC_CODE,C,8`, `BATCH_NO,C,20`, `APPLN_TYPE,N,1`, `APPLN_NO,C,10`, `INWARD_NO,N,10,0`, `COUPON_NO,C,10`, `STATUS,N,1`, `FLAG1`, `FLAG2`, `FLAG3`) VALUES
(2, 'BF01', '1MH74510', '1MH', 1, '', 0, '', 0, 0, 0, 0);
