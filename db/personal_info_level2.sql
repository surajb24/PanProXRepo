...
--
-- Table structure for table `personal_info_level2`
--

CREATE TABLE IF NOT EXISTS `personal_info_level2` (
...
--
-- Indexes for table `personal_info_level2`
--
ALTER TABLE `personal_info_level2`
 ADD PRIMARY KEY (`SR_NO,N,11`), ADD KEY `BATCH_ID,N,11` (`FORM_ID,C,18`);
...
--
-- AUTO_INCREMENT for table `personal_info_level2`
--
ALTER TABLE `personal_info_level2`
