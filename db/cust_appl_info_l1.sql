...
--
-- Dumping data for table `cust_appl_info_l1`
--

INSERT INTO `cust_appl_info_l1` (`SR_NO,N,1`, `FORM_ID,C,18`, `PCC_CODE,C,8`, `BATCH_NO,C,20`, `APPLN_TYPE,N,1`, `APPLN_NO,C,10`, `INWARD_NO,N,10,0`, `COUPON_NO,C,10`, `AREA_CODE,C,3`, `AO_TYPE,C,2`, `RANGE,C,3`, `AO_CODE,C,2`, `OLD_PAN,C,10`, `STATUS,N,1`, `FLAG1`, `FLAG2`, `FLAG3`) VALUES
(1, 'BF01', '1MH74510', '1MH', 1, '1', 2, '2', 'a', 'a', '1', '1', '', 1, 0, 0, 0);
