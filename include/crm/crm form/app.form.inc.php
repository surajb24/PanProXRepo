	...
	<tr>
	        ...
	        <td>
                    <select name="apptype" id="apptype" class="apptype req" onblur="valid_select(this,'Application Type','0');">
                                    <option value='<?php if(!empty($_SESSION['2-1-1'])) { echo $_SESSION['2-1-1'] ;} else { echo ''; } ?>'>
                                        <?php if(!empty($_SESSION['2-1-1'])) { echo $_SESSION['2-1-1'];} else { echo 'Select Application Type'; } ?>
                                    </option>
			<?php App_Type(); ?>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="app_no"  id="app_no" class="app_no req"  placeholder="APPLICATION NO" maxlength="10" onblur="valid_required(this,'Application number','0');" onkeypress="return ValidNum(event);" value="<?php echo $_SESSION['2-1-2'];?>">
                    </td>
                ...
                <tr>
                    ...
                    <th>Inward No</th>
                    <td>
                        <input type="text" name="inword_no"  id="inword_no" class="inword_no"  placeholder="INWARD NO"  value="<?php echo $_SESSION['2-1-3'];?>">
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="coupon_no"  id="coupon_no" class="coupon_no req"  placeholder="COUPON NO" maxlength="10" onkeypress="return ValidNum(event);" onblur="valid_required(this,'Coupon number','0');" value="<?php echo $_SESSION['2-1-4'];?>">
                    </td>
		...
		<tr class="AppC">
                    ...
                    <td>
                        <input type="text" name="pan_no" id="pan_no" class="pan_no req" placeholder="PAN NO" maxlength="10" onblur="valid_required(this,'PAN number','0'),PanValidate(this);" onkeyup="firstCharSpace(this);" value="<?php echo $_SESSION['2-1-9'];?>"/><div id="idreturn" style="color:red;"></div>
                    </td>
		</tr>
