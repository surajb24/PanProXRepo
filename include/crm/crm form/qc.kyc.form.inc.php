    ...
    <form name="kyc" action="" method="post">
        ...
        <table class="table2" >
            ...
            <tr>
                ...
                <td> 
                    <select name="maritalstatus" id="maritalstatus" class="maritalstatus req" onblur="valid_select(this,'Marital Status','0');" >
                        ...
                        <option value='<?php if(!empty($_SESSION['6-7-1'])) { echo $_SESSION['6-7-1']; } else { '';}?>'>
                                
                               <?php if(!empty($_SESSION['6-7-1'])) { echo $_SESSION['6-7-1']; } else { echo 'Select Marital Status'; } ?></option>
                            </option>
            ...
            <tr>
                ...
                <td> 
                    <select name="citystatus" id="citystatus" class="citystatus req" onblur="valid_select(this,'Citizenship Status','0');" >
                        ...
                        <option value='<?php if(!empty($_SESSION['6-7-2'])) { echo $_SESSION['6-7-2']; } else { '';}?>'>
                                
                               <?php if(!empty($_SESSION['6-7-2'])) { echo $_SESSION['6-7-2']; } else { echo 'Citizenship Status'; } ?></option>
                        </option>
            ...
            <tr class="residence">
                ...
                <td><input type="text" name='foreign_city' value='<?php echo $_SESSION['6-7-3']; ?>' class="RRSL" placeholder="IN CASE OF FOREIGN,COUNTRY OF CITIZENSHIP" maxlength="25" onkeyup="ValidFirstSpace(this),makeUpper(this);"></td>
            </tr> 
               ...
               <th>Occupation Details</th>
                <td> 
                    <select name="occupation" id="occupation" class="occupation req" onblur="valid_select(this,'Occupation Details','0');" >
                        ...
                        <option value='<?php if(!empty($_SESSION['6-7-4'])) { echo $_SESSION['6-7-4']; } else { '';}?>'>
                                
                               <?php if(!empty($_SESSION['6-7-4'])) { echo $_SESSION['6-7-4']; } else { echo 'Occupation Details'; } ?></option>
                        </option>
            ...
            <tr class="residence">
                ...
                <td> 
                    <select name="nonindividual" id="nonindividual" class="nonindividual req" onblur="valid_select(this,'Non Individuals','0');" >
                        ...
                        <option value='<?php echo $_SESSION['6-7-5']; ?>'>Y</option>
                        <option value='<?php echo $_SESSION['6-7-5']; ?>'>N</option>
            ...
            <tr class="residence">
                <th>Public Company(If listed On stock exchange)</th>
                    ...
                    <select name="stockexchange" id="stockexchange" class="stockexchange req" onblur="valid_select(this,'Stock Exechange','0');" >
                        ...
                        <option value='<?php echo $_SESSION['6-7-7']; ?>'>Y</option>
                        <option value='<?php echo $_SESSION['6-7-7']; ?>'>N</option>
            ...
            <tr class="residence">
                <th class="required">Foreign Exchange,Money Changer services</th>
                    ...
                    <select name="FMCS" id="FMCS" class="FMCS req" onblur="valid_select(this,'Foreign Exchange','0');">
                        ...
                        <option value="<?php echo $_SESSION['6-7-9']; ?>">Y</option>  
                        <option value="<?php echo $_SESSION['6-7-9']; ?>">N</option>  
                    </select>	
                ...
                <th>Gaming/Gambling/Lottery Services(Casinos and Betting Syndicates)</th>
                    <td>
                       <select name="GLS" id="GLS" class="GLS req" onblur="valid_select(this,'Gaming/Gambling/Lottery Services','0');">
                        ...
                        <option value="<?php echo $_SESSION['6-7-10']; ?>">Y</option>  
                        <option value="<?php echo $_SESSION['6-7-10']; ?>">N</option>  
                        </select> 
                    </td>
            </tr>
            <tr class="office">
                <th>Money/Lending/Pawning</th>
                    <td>
                       <select name="MLP" id="MLP" class="MLP req" onblur="valid_select(this,'Money/Lending/Pawing','0');">
                        ...
                        <option value="<?php echo $_SESSION['6-7-11']; ?>">Y</option>  
                        <option value="<?php echo $_SESSION['6-7-12']; ?>">N</option>  
                        </select>
                    </td>
            </tr>
                ...
                <th>Politically Exposed Person</th>
                    <td>
                        <select name="PEP" id="PEP" class="PEP req" onblur="valid_select(this,'Politically Exposed Person','0');">
                            ...
                            <option value="<?php echo $_SESSION['6-7-13']; ?>">Y</option>  
                            <option value="<?php echo $_SESSION['6-7-13']; ?>">N</option>  
                        </select> 
                    </td>
            </tr>
            <tr class="office">
                <th>Related Politically Exposed Person</th>
                    <td>
                        ...
                        <option value="<?php echo $_SESSION['6-7-14']; ?>">Y</option>  
                        <option value="<?php echo $_SESSION['6-7-14']; ?>">N</option>  
                        </select> 
                ...
                <th>Taxpayer Identification Number In the Country Of Residence</th>
                    <td>
                        <input type="text" name="TI" id="TI" class="TI req" placeholder="Taxpayer Identification Number In The Country Of Residence" maxlength="25" onkeyup="ValidFirstSpace(this),makeUpper(this);" 
                                 value="<?php echo $_SESSION['6-7-15']; ?>">
                    </td>
            </tr>
