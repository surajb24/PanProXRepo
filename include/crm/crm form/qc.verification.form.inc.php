    ...
    <form name="verification" action="" method="post">
        ...
        <table class="table2">
                ...
                <th class="required">Photo</th>
                    <td>
                        <SELECT name="Photo" id="Photo" class="Photo req" onblur="valid_select(this,'Photograph','0');">
                            <option value="<?php if(!empty($_SESSION['5-6-1'])) { echo $_SESSION['5-6-1']; } else { "";}?>">
                                        <?php if(!empty($_SESSION['5-6-1'])) { echo $_SESSION['5-6-1']; } else { echo 'Select Photo'; } ?>
                            </option>
                ...
                <th class="required">Sign</th>
                    <td>
                        <select name="Sign" id="Sign" class="Sign req" onblur="valid_select(this,'Signature','0');">
                             <option value="<?php if(!empty($_SESSION['5-6-2'])) { echo $_SESSION['5-6-2']; } else { "";}?>">
                                        <?php if(!empty($_SESSION['5-6-2'])) { echo $_SESSION['5-6-2']; } else { echo 'Select Sign'; } ?>
                            </option>
                            <option value="Y">Yes</option>
                            <option value="N">No</option>
                         </select>
            ...
            <tr>
                ...
                <td>
                    <select name="POI" id="POI" class="POI req" onblur="valid_select(this,'Identity Proof','0');">
            ...
            <tr>
                <th class="required">Proof of Address</th>
                    <td>
                       <select name="POA" id="POA" class="POA req" onblur="valid_select(this,'Address Proof','0');">
            ...
            <tr>
                ...
                <td>
                    <select name="Pdob" id="Pdob" class="Pdob req" onblur="valid_select(this,'Date of Birth Proof','0');" onkeypress="if (event.keyCode == 13) return validatedob(this)">
                ...
                <th class="required">Capacity</th>
                    <td>
                        <select name="Capacity" id="Capacity" class="Capacity req" onblur="valid_select(this,'capacity','0');">
                               <option value="<?php if(!empty($_SESSION['5-6-8'])) { echo $_SESSION['5-6-8']; } else { "";}?>">
                                        <?php if(!empty($_SESSION['5-6-8'])) { echo $_SESSION['5-6-8']; } else { echo 'Select Capacity'; } ?>
                                </option>
                                <?php Capacity();?>
                    </select>     
                        </select>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="Place" id="Place" class="Place req" placeholder="PLACE" maxlength="30" onkeypress="return ValidAlpha(event);" style="text-transform: uppercase;" onKeyup="ValidFirstSpace(this);" onblur="valid_required(this,'place','0'),this.value = this.value.toUpperCase();"
                           value="<?php echo $_SESSION['5-6-9']; ?>">
                </td>
            </tr>
            <tr>
                <th class="required">Date</th>
                    <td>
                       <input type="text" name="Vdate" id="date1" maxlength="10"  placeholder="DD/MM/YYYY" class="date req" onblur="validatedob(this), valid_required(this,'Date Of Birth','0'); "
                              value="<?php echo $_SESSION['5-6-10']; ?>">
                    </td>
            </tr>
        </table>
    </center>
        ...
        <div align="center" class="buttons">
                        ...
                        <button type="submit" class="btns" id=""  name="Level1_Final" onclick="closewin();">Final Submit</button>
