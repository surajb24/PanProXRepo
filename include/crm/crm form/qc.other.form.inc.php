	...
	<form name="other"  action="" method="post">
                    ...
                    <th class="required">Status Of Applicant</th>
                        ...
                        <td>
                            ...
                            <select name="SOA" id="SOA" class="SOA req" onblur="valid_select(this,'Status of Applicant ','0');">
                                ...
                                <option value="<?php if(!empty($_SESSION['5-4-1'])) { echo $_SESSION['5-4-1']; } else { "";}?>">
                               <?php if(!empty($_SESSION['5-4-1'])) { echo $_SESSION['5-4-1']; } else { echo 'Status Of Applicant'; } ?></option>
                                </option>
			<?php Status_Applicant(); ?>
                ...
                <tr class="Resig">
                    ...
                    <td>
                        <input type="text" name="RegNo"  id="RegNo" class="RegNo req"  placeholder="REGISTRATION NO" maxlength="30" onblur="valid_required(this,'Registration No','0');" onkeyup="firstCharSpace(this);" 
                               value="<?php echo $_SESSION['5-4-2']; ?>">
                    </td><td></td>
                ...
                <tr class="appisd oprat">
                    ...
                    <td>
                        ...
                        <select name="CountryC" id="CountryC" class="CountryC req" onblur="valid_select(this,'Country Citizenship','0');">
                                <option value="<?php if(!empty($_SESSION['5-4-3'])) { echo $_SESSION['5-4-3']; } else { "";}?>">
                               <?php if(!empty($_SESSION['5-4-3'])) { echo $_SESSION['5-4-3']; } else { echo 'Select Country of Citizenship'; } ?></option>
                                </option>
			<?php Country(); ?>
                 ...
                 <tr class="adarAA">
                    ...
                    <td>
                        ...
                        <input type="text" name="AadharNo"  id="AadharNo" class="AadharNo"  placeholder="AADHAR NO" minlength="12" maxlength="12"  onkeypress="return ValidNum(event);" onblur="adhr(this);"
                               ...
                               value="<?php echo $_SESSION['5-4-5']; ?>"><div id="idaddar" style="color:red;"></div>
                    </td><td></td>
                ...
                <tr class="appcom">
                    ...
                    <td>
                       ...
                       <input type="checkbox" name="Salary"  id="Salary" class="chk" onchange="emptyContactSession(this);" value="Y"<?php if($_SESSION['5-4-6']=="Y") { echo "checked"; } ?>> Salary
                    ...
                    <td>
                       ...
                       <input type="checkbox" name="CG"  id="CG" class="chk" value="Y" <?php if($_SESSION['5-4-7']=="Y") { echo "checked"; } ?>>Capital Gains
                ...
                <tr class="appcom">
                    <td>
                        ...
                        <input type="checkbox" name="IHP"  id="IHP" class="chk" value="Y" <?php if($_SESSION['5-4-8']=="Y") { echo "checked"; } ?>>Income from House Property
                    ...
                    <td>
                         ...
                         <input type="checkbox" name="IOS"  id="IOS"class="chk" value="Y" <?php if($_SESSION['5-4-9']=="Y") { echo "checked"; } ?>>Income from Other source
                ...
                <tr class="appcom">
                    ...
                    <td>
                        <input type="checkbox" name="BPC"  id="BPC" class="chk" <?php if($_SESSION['5-4-10'] == "Y") { echo "checked"; } ?> />Income From Business
                    </td>
                    <td>Code<input type="text"  name="SCode" id="SCode" class="chkcode req" placeholder="Business code" maxlength="2" size="2" onblur="valid_required(this,'Business Code..','0');" onkeyup="isNumber(this);" value="<?php echo $_SESSION['5-4-11']; ?>"></td>
                ...
                <tr class="appcom">
                    <td>
                        ...
                        <input type="checkbox" name="NI"  id="NI" class="chk" value="Y" <?php if($_SESSION['5-4-12']=="Y") { echo "checked"; } ?>>No Income
                    ...
                    <th ROWSPAN="2">Mention other Permanent Account Number (PANs)inadvertently allotted to you</th>
                     <td>
                         PAN 1&nbsp;&nbsp;<input type="text" name="PAN1"  id="PAN1" class="PAN1" placeholder="PAN1" maxlength="10" onblur="PanValidate(this);"
                                                 value="<?php echo $_SESSION['5-4-13']; ?>"><div id="idreturn" style="color:red;"></div>
                    </td>
                    <td>
                        PAN 2&nbsp;&nbsp;<input type="text" name="PAN2"  id="PAN2" class="PAN2" placeholder="PAN2" maxlength="10" onblur="PanValidate(this);" 
                                                value="<?php echo $_SESSION['5-4-14']; ?>"><div id="idreturn" style="color:red;"></div>
                ...
                <tr class="AppC">
                    ...
                    <td>
                        PAN 3&nbsp;&nbsp;<input type="text" name="PAN3"  id="PAN3" class="PAN3"  placeholder="PAN3" maxlength="10" onblur="PanValidate(this);"
                                                value="<?php echo $_SESSION['5-4-15']; ?>"><div id="idreturn" style="color:red;"></div>
                    </td>
                    <td>
                        PAN 4&nbsp;&nbsp;<input type="text" name="PAN4"  id="PAN4" class="PAN4"  placeholder="PAN4" maxlength="10" onblur="PanValidate(this);" 
                                                value="<?php echo $_SESSION['5-4-16']; ?>"><div id="idreturn" style="color:red;"></div>
                    </td> 
		</tr>
